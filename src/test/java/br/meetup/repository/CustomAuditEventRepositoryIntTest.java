package br.meetup.repository;

import br.meetup.MeetupApp;
import br.meetup.config.Constants;
import br.meetup.config.audit.AuditEventConverter;
import br.meetup.domain.PersistentAuditEvent;
...
import static br.meetup.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
